...
if ($search !== '') {
    $statement = $pdo->prepare(
        'SELECT assignment_id, title, description FROM assignments
    ...
    $statement = $pdo->query('SELECT assignment_id, title, description FROM assignments ORDER BY assignment_id DESC');
    $assignments = $statement->fetchAll();
}
